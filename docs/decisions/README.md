...
| [0003](0003-pilot-cell-squad-shape.md) | Proposed | Staff a four-seat pilot cell with named floor and CWMS dependencies; scale only once open question 1 is settled. |
