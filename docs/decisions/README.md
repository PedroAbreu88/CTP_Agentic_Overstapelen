...
| [0003](0003-position-map-over-per-crate-scan.md) | Proposed | Read a cart position map from one scan instead of scanning every crate. Confirm by observing whether crates stay in their picked positions. |
